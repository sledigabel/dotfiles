...
vim.api.nvim_set_keymap("n", "<leader>ti", "<cmd>lua require('telescope').extensions.gh.issues()<cr>", { noremap = true })
vim.api.nvim_set_keymap("n", "<leader>tp", "<cmd>lua require('telescope').extensions.gh.pull_requests()<cr>", { noremap = true })
