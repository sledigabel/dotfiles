...
wk.add({
  ...
  { "<leader>O/", "<cmd>ObsidianSearch<cr>", desc = "Search in Obsidian", remap = false },
  { "<leader>On", "<cmd>ObsidianNew<cr>", desc = "New file in Obsidian", remap = false },
  { "<leader>Oo", "<cmd>ObsidianOpen<cr>", desc = "Open in Obsidian", remap = false },
})
